...
function MedicalConfirmation() {
    return(
        <div>
            <Markdown children={title} align='center'/>

            <table border='1px solid black' className="chartInfo">
                <tr>
                    <th>차트번호</th>
                    <th>이름</th>
                    <th>주민번호</th>
            ...
            <br/>
            <table border='1px solid black' className="treatmentPeriod">
                <tr>
                    <th>치료 기간</th>
                    <td>
            ...
            <br/>
            <table border='1px solid black' className="diseaseInfo">
                <tr>
            ...
            <br/>
            <table border='1px solid black' className="submitInfo">
                <tr>
                    <th>용도</th>
                    <td>
                        <select>
